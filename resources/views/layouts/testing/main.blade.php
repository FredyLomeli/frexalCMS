...
<link rel="stylesheet" id="wp-block-library-css" href="{{ asset('secutech/style.min.css') }}" media="all">
...
<link rel="stylesheet" id="contact-form-7-css" href="{{ asset('secutech/styles.css') }}" media="all">
<link rel="stylesheet" id="video_popup_close_icon-css" href="{{ asset('secutech/close-button-icon.css') }}" media="all">
<link rel="stylesheet" id="oba_youtubepopup_css-css" href="{{ asset('secutech/YouTubePopUp.css') }}" media="all">
<link rel="stylesheet" id="style-css" href="{{ asset('secutech/style.css') }}" media="all">
<link rel="stylesheet" id="fancybox-css" href="{{ asset('secutech/fancybox.min.css') }}" media="all">
...
<script src="{{ asset('secutech/YouTubePopUp.js') }}" id="oba_youtubepopup_activate-js"></script>
<link rel="https://api.w.org/" href="https://garantiwebdesign.com/wordpress/secutech/wp-json/"><link rel="alternate" title="JSON" type="application/json" href="https://garantiwebdesign.com/wordpress/secutech/wp-json/wp/v2/pages/5"><link rel="EditURI" type="application/rsd+xml" title="RSD" href="https://garantiwebdesign.com/wordpress/secutech/xmlrpc.php?rsd">
<meta name="generator" content="WordPress 6.6.1">
<link rel="canonical" href="https://garantiwebdesign.com/wordpress/secutech/">
<link rel="shortlink" href="https://garantiwebdesign.com/wordpress/secutech/">
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="https://garantiwebdesign.com/wordpress/secutech/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgarantiwebdesign.com%2Fwordpress%2Fsecutech%2F">
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="https://garantiwebdesign.com/wordpress/secutech/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgarantiwebdesign.com%2Fwordpress%2Fsecutech%2F&amp;format=xml">
        ...
        <div class="row">
            <div class="col-12">
                <div class="h-yazi-ortalama h-yazi-margin-orta-3">
                    <h2 class="h2-baslik-hizmetler-2 wow fadeInLeft" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;"> Your Home and Workplace Are Safe 24/7 </h2>
                </div>
                    <p class="h2-baslik-hizmetler-2__paragraf wow fadeInLeft" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
    ...
    <div class="container">
            ...
            <div class="col-lg-12">
                ...
                <div class="or">
                    ...
                    <div class="ortd">
                        <a href="http://garantiwebdesign.com/wordpress/secutech/wp-content/uploads/2022/10/templatemonster2.mp4" class="custom-button vbtn-fluid vp-a vp-yt-type"><i class="flaticon-youtube vdicon"></i></a>
                    </div>
                </div>
            </div>
        </div>
...
<section class="why-us">
    <div class="container">
        <div class="row">
            <div class="col-12">
                <div class="h-yazi-ortalama h-yazi-margin-orta-3">
                    <h2 class="h2-baslik-hizmetler-21 wow fadeInLeft" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;"> Why Choose Us? </h2>
                </div>
                    <p class="h2-baslik-hizmetler-21__paragraf wow fadeInLeft" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                    Check out the camera security systems we offer.                    </p>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
                        <div class="col-lg-3 ds wow zoomIn" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-control-panel"></i></p></div>
                        <div class="bosluk333"></div>
                        ...
                        <a class="btn-3" href="https://garantiwebdesign.com/wordpress/secutech/#"><p class="btnn2">Learn more</p></a>
                </div>
            </div>
        </div>
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="0.7s" style="visibility: hidden; animation-delay: 0.7s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-cctv"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="0.8s" style="visibility: hidden; animation-delay: 0.8s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-alarm-system"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="0.9s" style="visibility: hidden; animation-delay: 0.9s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-barrier"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="1s" style="visibility: hidden; animation-delay: 1s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-fire-alarm-1"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="1.1s" style="visibility: hidden; animation-delay: 1.1s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-fingerprint-scan"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="1.2s" style="visibility: hidden; animation-delay: 1.2s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-security-scan"></i></p></div>
                        <div class="bosluk333"></div>
                ...
                <div class="col-lg-3 ds wow zoomIn" data-wow-delay="1.3s" style="visibility: hidden; animation-delay: 1.3s; animation-name: none;">
        <div class="dep">
            <div class="or56">
                <div class="iconwr or56"><p class="dzv"><i class="flaticon-surveillance"></i></p></div>
                        <div class="bosluk333"></div>
    ...
    <div class="dep2">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                                        <h2 class="h2-baslik-anasayfa-wt wow fade" style="visibility: hidden; animation-name: none;">Get A Quote Now!</h2>
                    <div role="form" class="wpcf7" id="wpcf7-f7659-o1" lang="en-US" dir="ltr">
<div class="screen-reader-response"><p role="status" aria-live="polite" aria-atomic="true"></p> <ul></ul></div>
<form action="https://garantiwebdesign.com/wordpress/secutech/#wpcf7-f7659-o1" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
...
<div class="row">
<div class="col-lg-4">
<div class="form__grup wow fadeInLeft" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                <span class="wpcf7-form-control-wrap" data-name="menu-684"><select name="menu-684" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false"><option value="Home Or Business?">Home Or Business?</option><option value="For Home">For Home</option><option value="For Business">For Business</option></select></span>
            </div>
</div>
<div class="col-lg-4">
<div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                <span class="wpcf7-form-control-wrap" data-name="menu-683"><select name="menu-683" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false"><option value="Service Type">Service Type</option><option value="Home Security">Home Security</option><option value="Camera Systems">Camera Systems</option><option value="Alarm Systems">Alarm Systems</option><option value="Barrier Systems">Barrier Systems</option><option value="Fire Systems">Fire Systems</option><option value="Fingerprint Reading">Fingerprint Reading</option><option value="Turnstile Systems">Turnstile Systems</option><option value="Camera Record">Camera Record</option></select></span>
            </div>
</div>
<div class="col-lg-4">
<div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                <span class="wpcf7-form-control-wrap" data-name="menu-685"><select name="menu-685" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false"><option value="System Size">System Size</option><option value="Small (1-3 Locations)">Small (1-3 Locations)</option><option value="Medium (4-8 Locations)">Medium (4-8 Locations)</option><option value="Large (9-15 Locations)">Large (9-15 Locations)</option><option value="Other">Other</option></select></span>
            </div>
</div>
<div class="col-lg-4">
<div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
...
<div class="wow fadeInUp" data-wow-delay="0.8s" style="visibility: hidden; animation-delay: 0.8s; animation-name: none;">
                <input type="submit" value="Get A Quote →" class="wpcf7-form-control has-spinner wpcf7-submit custom-button"><span class="wpcf7-spinner"></span>
            </div>
</div>
</div>
</div>
...
<div class="hero66 wow fadeInLeft" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">
    <img class="commentpeop1" src="{{ asset('secutech/comment-people-2.png') }}" alt="">
</div>
<div class="hero88 wow fadeInRight" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
    <img class="commentpeop2" src="{{ asset('secutech/comment-people-5.png') }}" alt="">
</div>
<div class="hero88 wow fadeInRight" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
    <img class="commentpeop3" src="{{ asset('secutech/comment-people-1.png') }}" alt="">
</div>
<div class="hero88 wow fadeInLeft" data-wow-delay="0.7s" style="visibility: hidden; animation-delay: 0.7s; animation-name: none;">
    <img class="commentpeop4" src="{{ asset('secutech/comment-people-4.png') }}" alt="">
</div>
    <div class="container">
        <div class="row">
        <div class="col-12 wow animated fadeIn animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
            <div class="h-yazi-ortalama h-yazi-margin-orta-3">
                <div class="icon wow fadeInUp" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;"><i class="flaticon-chat-1"></i></div>
                <h2 class="h2-baslik-hizmetler-yorum wow fadeInUp" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;"> What Are Our Customers Saying ? </h2> 
            </div>
                <p class="h2-baslik-hizmetler-yorum__yorum wow fadeInUp" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                Opinions from our happy customers.                </p>
                <div class="bosluk3a"></div>
            </div>
            <div class="col-12">
                <div class="carousel-classes swiper-container-horizontal">
                <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1450px, 0px, 0px);"><div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate swiper-slide-duplicate-active" data-wow-delay="0.5s" data-swiper-slide-index="0" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                    <div class="class-box">
                    <div class="testimonial-card">
                        <div class="testimon-text">
                        We had camera systems installed for our office. We received a fast and safe service. A team that does your job professionally.                            <i class="fas fa-quote-right quote" aria-hidden="true"></i>
                        </div>
                ...
                <!-- end swiper-slide -->
                    ...
                    <div class="testimonial-card">
                        <div class="testimon-text">
                        We renewed the camera system in our building. And they installed all the systems in a very short time. Thank you.                            <i class="fas fa-quote-right quote" aria-hidden="true"></i>
                        </div>
                ...
                <!-- end swiper-slide -->
                    ...
                    <div class="testimonial-card">
                        <div class="testimon-text">
                        It is a quality company that we work with for the security systems of our store. They do their job diligently. Good luck. Thanks.                            <i class="fas fa-quote-right quote" aria-hidden="true"></i>
                        </div>
                        <h2 class="h2-baslik-hizmetler-2cc">Robert</h2>
                        </div>
                        </div>
                <!-- end swiper-slide -->
                </div><div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate swiper-slide-prev" data-wow-delay="0.5s" data-swiper-slide-index="3" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                    <div class="class-box">
                    <div class="testimonial-card">
                        <div class="testimon-text">
                        We wanted a camera system for our shop. We encountered a friendly and expert team. Everything happened exactly as we wanted.                            <i class="fas fa-quote-right quote" aria-hidden="true"></i>
                        </div>
                ...
                <!-- end swiper-slide -->
                                ...
                                <div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate-prev" data-wow-delay="0.5s" data-swiper-slide-index="3" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                    <div class="class-box">
                    <div class="testimonial-card">
                        <div class="testimon-text">
                        We wanted a camera system for our shop. We encountered a friendly and expert team. Everything happened exactly as we wanted.                            <i class="fas fa-quote-right quote" aria-hidden="true"></i>
...
<h6>.</h6>
    <div class="container">
        <div class="row">     
            ...
            <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        <img src="{{ asset('secutech/cameraa-1.jpg') }}" alt="Marka 1" class="marka">
    </div>
    </div>
        <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        <img src="{{ asset('secutech/cameraa-6.jpg') }}" alt="Marka 1" class="marka">
    </div>
    </div>
        <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        <img src="{{ asset('secutech/cameraa-5.jpg') }}" alt="Marka 1" class="marka">
    </div>
    </div>
        <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        <img src="{{ asset('secutech/cameraa-3.jpg') }}" alt="Marka 1" class="marka">
    </div>
    </div>
        <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        ...
        <div class="col-lg-2">
    <div class="h-yazi-ortalama h-yazi-margin-kucuk-21 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
        <img src="{{ asset('secutech/cameraa-2.jpg') }}" alt="Marka 1" class="marka">
    </div>
    </div>
...
<div class="container">
    ...
    <div class="depff">
        <div class="container">
            <div class="row">
                                        ...
                                        <div class="row yk" onclick="location.href=&#39;#&#39;;" style="cursor:pointer;">
                        <div class="col-lg-3">
                            <div class="iconheal"><i class="flaticon-24-hours"></i></div>
                        </div>
                        <div class="col-lg-9">
                            <h4 class="services-kutu2--wt13 wow fade" style="visibility: hidden; animation-name: none;">Customer Service</h4>
                            <h2 class="h2-baslik-anasayfa-wthe wow fade" style="visibility: hidden; animation-name: none;">+123 456 78 90 01</h2>
                        </div>
                    </div>
                </div>
                                <div class="col-lg-4 lefthealtfooter">
                                        <div class="row yk" onclick="location.href=&#39;#&#39;;" style="cursor:pointer;">
                        <div class="col-lg-3">
                            <div class="iconheal"><i class="flaticon-email-1"></i></div>
                        </div>
                        <div class="col-lg-9">
                            <h4 class="services-kutu2--wt13 wow fade" style="visibility: hidden; animation-name: none;">Information and Complaint</h4>
                            <h2 class="h2-baslik-anasayfa-wthe wow fade" style="visibility: hidden; animation-name: none;">example@example.com</h2>
                        </div>
                    </div>
                </div>
                                <div class="col-lg-4 lefthealtfooter">
                                        <div class="row yk" onclick="location.href=&#39;#&#39;;" style="cursor:pointer;">
                        <div class="col-lg-3">
                            <div class="iconheal"><i class="flaticon-pin"></i></div>
                        </div>
                        <div class="col-lg-9">
                            <h4 class="services-kutu2--wt13 wow fade" style="visibility: hidden; animation-name: none;">Visit Us</h4>
                            <h2 class="h2-baslik-anasayfa-wthe wow fade" style="visibility: hidden; animation-name: none;">New Jersey, USA</h2>
                        </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="logo wow animated fadeInUp animated" data-wow-delay="0s" style="visibility: hidden; animation-delay: 0s; animation-name: none;"> <img src="{{ asset('secutech/secutech-logo-footer.png') }}" alt="Image"> </div>
            <!-- end logo -->
            <p style="color:#fff;text-align:center;">We unite with our expert staff and help make your world safer.</p>            <div class="bosluk333"></div>
            <ul class="footer-social cce wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                            <li><a href="https://garantiwebdesign.com/wordpress/secutech/#"><i class="icon-social-facebook iconsociaf"></i></a></li>
             
                        <li><a href="https://garantiwebdesign.com/wordpress/secutech/#"><i class="icon-social-instagram iconsociaf"></i></a></li>
             
                            <li><a href="https://garantiwebdesign.com/wordpress/secutech/#"><i class="icon-social-twitter iconsociaf"></i></a></li>
             
            </ul>
            </div>
            
            <!-- end col-2 -->
            <div class="col-lg-3 cce1 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                <h6 class="widget-title">Services</h6>
                <div class="footer-menu cce">
                    <div class="menu-services-container"><ul id="menu-services" class="menu" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement"><li id="menu-item-2082" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2082"><a href="https://garantiwebdesign.com/wordpress/secutech/home-security/">Home Security</a></li>
<li id="menu-item-2081" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2081"><a href="https://garantiwebdesign.com/wordpress/secutech/camera-systems/">Camera Systems</a></li>
<li id="menu-item-2080" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2080"><a href="https://garantiwebdesign.com/wordpress/secutech/alarm-systems/">Alarm Systems</a></li>
<li id="menu-item-2079" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2079"><a href="https://garantiwebdesign.com/wordpress/secutech/barrier-systems/">Barrier Systems</a></li>
</ul></div>                </div>
            </div>
            <!-- end col-2 -->
            <div class="col-lg-3 cce wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                <h6 class="widget-title">Quick Links</h6>
                <div class="footer-menu cce">
                    <div class="menu-quick-links-container"><ul id="menu-quick-links" class="menu" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement"><li id="menu-item-7756" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-7756"><a href="https://garantiwebdesign.com/wordpress/secutech/get-a-quote/">Get A Quote</a></li>
<li id="menu-item-2745" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2745"><a href="https://garantiwebdesign.com/wordpress/secutech/all-services/">Services</a></li>
<li id="menu-item-8401" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8401"><a href="https://garantiwebdesign.com/wordpress/secutech/references/">References</a></li>
<li id="menu-item-1734" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1734"><a href="https://garantiwebdesign.com/wordpress/secutech/contact/">Contact</a></li>
</ul></div>                </div>
            </div>
            <div class="col-lg-4 cce1 wow animated fadeInUp animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
            <h6 class="widget-title">Superior Experience</h6>
            <p style="text-align: center;"><span style="color: #ffffff;">Our story began a quarter of a century ago; Today, we are the world leader in the industry, with hundreds of thousands of security guards across continents.</span></p>

<div class="or">
<a class="btn-3" href="https://garantiwebdesign.com/wordpress/secutech/#%3E"><p class="btnn2">More Information →</p></a>
</div>        <!-- end row --> 
        </div>
    <!-- Copyright -->
    <div class="container">
...
var wpcf7 = {"api":{"root":"https:\/\/garantiwebdesign.com\/wordpress\/secutech\/wp-json\/","namespace":"contact-form-7\/v1"}};
</script>
<script src="{{ asset('secutech/index.js') }}" id="contact-form-7-js"></script>
<script src="{{ asset('secutech/team.js') }}" id="team-js"></script><style media="all" id="fa-v4-font-face">/*!

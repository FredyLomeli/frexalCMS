...
<link rel="alternate" title="oEmbed (JSON)" type="application/json+oembed" href="#wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgarantiwebdesign.com%2Fwordpress%2Fsecutech%2F">
<link rel="alternate" title="oEmbed (XML)" type="text/xml+oembed" href="#wp-json/oembed/1.0/embed?url=https%3A%2F%2Fgarantiwebdesign.com%2Fwordpress%2Fsecutech%2F&amp;format=xml">
...
<body class="page-loaded">
    ...
    <aside class="side-widget">
        <div class="inner">
            ...
            <div class="hide-mobile">
                                ...
                                <ul id="menu-mobile-menu" class="nav navbar-nav" itemscope="" itemtype="http://www.schema.org/SiteNavigationElement">
                                    ...
                                    <li class="menu-item" style="opacity: 1;">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown">
                                            <li  class="menu-item" style="opacity: 1;">
                                                <a itemprop="url" href="#about-us/" class="dropdown-item">
                                                    <span itemprop="name">¿Quiénes somos?</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" style="opacity: 1;">
                                                <a itemprop="url" href="#our-team/" class="dropdown-item">
                                                    <span itemprop="name">Nuestro equipo</span>
                                                </a>
                                            </li>
                                            <li class="menu-item" style="opacity: 1;">
                                                <a itemprop="url" href="#faq/" class="dropdown-item">
                                    ...
                                    <li class="menu-item" style="opacity: 1;">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="menu-item-dropdown">
                                            <li class="menu-item" style="opacity: 1;">
                                                <a itemprop="url" href="#home-security/" class="dropdown-item">
                                    ...
                                    <li class="menu-item" style="opacity: 1;">
                                        <a itemprop="url" href="#references/" class="nav-link">
                                            <span itemprop="name">Referencias</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" style="opacity: 1;">
                                        <a itemprop="url" href="#blog/" class="nav-link">
                ...
                <small>© 2024 ISSI - Todos los derechos reservados.</small> 
            </div>
        </div>
    </aside>
    <nav class="navbar navbar-expand-md navbar-light bg-light">
        <div class="container">
            <!-- Logo Menu Desktop -->
            <div class="logo"><a href="#"><img src="{{ asset('secutech/logo.png') }}" alt="Image"></a></div>
                <div class="site-menu">
    ...
    <section class="hakkimizda-bolumu-anasayfa">
        ...
        <div class="tablo">
            ...
            <div class="tablo--1-ve-3 wow fadeInUp" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                ...
                <a href="#about-us/" class="btn-2 wow fadeInUp" data-wow-delay="0.8s" style="visibility: hidden; animation-delay: 0.8s; animation-name: none;"><p class="btnn2">Get to know us</p></a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="h-yazi-ortalama h-yazi-margin-orta-3">
                        <h2 class="h2-baslik-hizmetler-2 wow fadeInLeft" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">
                ...
                <div class="col-lg-12">
                    <div class="live-video-img">
                        <div class="or">
                            ...
                            <div class="ortd">
                                <a href="http://garantiwebdesign.com/wordpress/secutech/wp-content/uploads/2022/10/templatemonster2.mp4" class="custom-button vbtn-fluid vp-a vp-yt-type">
                                    <i class="flaticon-youtube vdicon"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="why-us">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="h-yazi-ortalama h-yazi-margin-orta-3">
                        <h2 class="h2-baslik-hizmetler-21 wow fadeInLeft" data-wow-delay="0.4s" style="visibility: hidden; animation-delay: 0.4s; animation-name: none;">
                            Why Choose Us? </h2>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                ...
                                <div role="form" class="wpcf7" id="wpcf7-f7659-o1" lang="en-US" dir="ltr">
                                    ...
                                    <form action="#wpcf7-f7659-o1" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInLeft" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="menu-684">
                                                            <select name="menu-684" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false">
                                                                <option value="Home Or Business?">Home Or Business?</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="menu-683">
                                                            <select name="menu-683" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false">
                                                                <option value="Service Type">Service Type</option>
                                                                <option value="Home Security">Home Security</option>
                                                                <option value="Camera Systems">Camera Systems</option>
                                                                <option value="Alarm Systems">Alarm Systems</option>
                                                                <option value="Barrier Systems">Barrier Systems</option>
                                                                <option value="Fire Systems">Fire Systems</option>
                                                                <option value="Fingerprint Reading">Fingerprint Reading</option>
                                                                <option value="Turnstile Systems">Turnstile Systems</option>
                                                                <option value="Camera Record">Camera Record</option>
                                                            </select>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="menu-685">
                                                            <select name="menu-685" class="wpcf7-form-control wpcf7-select wpcf7-validates-as-required" aria-required="true" aria-invalid="false">
                                                                <option value="System Size">System Size</option>
                                                                <option value="Small (1-3 Locations)">Small (1-3 Locations)</option>
                                                                <option value="Medium (4-8 Locations)">Medium (4-8 Locations)</option>
                                                                <option value="Large (9-15 Locations)">Large (9-15 Locations)</option>
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="text-667">
                                                            <input type="text" name="text-667" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-popup__input" aria-required="true" aria-invalid="false" placeholder="Full Name">
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="email-217">
                                                            <input type="email" name="email-217" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-email wpcf7-validates-as-required wpcf7-validates-as-email form-popup__input" aria-required="true" aria-invalid="false" placeholder="Email Address">
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form__grup wow fadeInUp" data-wow-delay="0.6s" style="visibility: hidden; animation-delay: 0.6s; animation-name: none;">
                                                        <span class="wpcf7-form-control-wrap" data-name="text-661">
                                                            <input type="text" name="text-661" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-popup__input" aria-required="true" aria-invalid="false" placeholder="Phone Number">
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="col-lg-12">
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 wow animated fadeIn animated" data-wow-delay="0.5s" style="visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                    ...
                    <div class="col-12">
                        <div class="carousel-classes swiper-container-horizontal">
                            <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(-1450px, 0px, 0px);">
                                <div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate swiper-slide-duplicate-active" data-wow-delay="0.5s" data-swiper-slide-index="0" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                                    <div class="class-box">
                                ...
                                <div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate swiper-slide-duplicate-next" data-wow-delay="0.5s" data-swiper-slide-index="1" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                                    <div class="class-box">
                                        <div class="testimonial-card">
                                            <div class="testimon-text">
                                ...
                                <div class="swiper-slide wow animated fadeInLeft swiper-slide-duplicate swiper-slide-prev" data-wow-delay="0.5s" data-swiper-slide-index="3" style="width: 332.5px; margin-right: 30px; visibility: hidden; animation-delay: 0.5s; animation-name: none;">
                                    <div class="class-box">
                                        <div class="testimonial-card">
                                            <div class="testimon-text">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xl-2 cce col-lg-4 cce">
                    <div class="logo wow animated fadeInUp animated" data-wow-delay="0s" style="visibility: hidden; animation-delay: 0s; animation-name: none;"> 
                        <img src="{{ asset('secutech/secutech-logo-footer.png') }}" alt="Image"> 
                    </div>
                    <!-- end logo -->
